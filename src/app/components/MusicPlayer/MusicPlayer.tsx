  ...
  return (
    <div className={styles.bar}>
      <div className={styles.leftPanel}>
        <div className={styles.modeButton} onClick={handlePlay}>
          {isPlaying ? <MdOutlinePause /> : <RiPlayFill />}
        </div>
        <div className={styles.modeButton} onClick={handleStop}>
          <RiStopFill />
        </div>
        <div className={styles.modeButton} onClick={handleRestart}>
          <RiRewindFill />
        </div>
      </div>
      ...
      <div
        className={`${styles.modeButton} ${isLooping ? styles.active : ''}`}
        onClick={toggleLoop}
      >
        <RiLoopRightFill />
      </div>
      <audio ref={audioRef} src={`/sounds/${musicFile}`} preload="auto" />
      <a href={musicUri} className={styles.link}>
